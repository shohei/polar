...
\begin{eqnarray*}
	\Delta t = \frac{F}{\sqrt{(\Delta x)^2+(\Delta y)^2}}\cdot \frac{1}{60}\cdot\frac{1}{1000}
\end{eqnarray*}
...
&=&\frac{\alpha}{60\cdot1000} \cdot \frac{F}{\sqrt{(\Delta x)^2+(\Delta y)^2}} \cdot \sqrt{\left( r_n - r_{n-1} \right)^2 + \left(\frac{r_n+r_{n-1}}{2} \right)^2  \left( \theta_n - \theta_{n-1} \right)^2} \nonumber \\
&=&\alpha^\prime F \sqrt{\frac{\left( r_n - r_{n-1} \right)^2 + \left(\frac{r_n+r_{n-1}}{2} \right)^2  \left( \theta_n - \theta_{n-1} \right)^2}{(r_n \cos\theta_n - r_{n-1} \cos\theta_{n-1})^2+(r_n \sin\theta_n - r_{n-1} \sin\theta_{n-1})^2}} \nonumber \\
\end{eqnarray}
